...
import type { Combo, WeatherType, Page, ProductSuggestion } from '../types';
...
export const getComboSuggestions = (id: number) =>
  api.get<ProductSuggestion[]>(`/combos/${id}/suggestions`)
